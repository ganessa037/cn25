...
const Document = sequelize.define(
  "Document",
  {
    ...
    processingStatus: { type: DataTypes.ENUM("uploaded", "processing", "processed", "failed"), defaultValue: "uploaded" },
  ...
  {
    tableName: "documents",
    indexes: [{ fields: ["userId"] }, { fields: ["vehicleId"] }, { fields: ["documentType"] }],
  }
);
